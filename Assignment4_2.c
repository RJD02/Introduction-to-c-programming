...
int main()
{
   ...
   int a[n];
   scanArray(a, n);
   sort(a, n);                          //This is allowed, until you put semicolons in the right space and in right order
   int count = 1, val = a[0];
   int prev = a[0];                     //This is allowed too. With this initialization we skip one iteration
   for (int i = 1; i < n; i++)
   {
